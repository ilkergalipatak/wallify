...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-q!z9$xw$k#p5r0*8y=_e^rvwn9m)@v%_v)f3q7_0(#!g-o$-7g')
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR.parent, 'cdn')
...
# CDN Folder
CDN_FOLDER = os.path.join(BASE_DIR.parent, 'cdn')
